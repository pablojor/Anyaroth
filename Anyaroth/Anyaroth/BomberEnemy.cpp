...
BomberEnemy::BomberEnemy(Player* player, Game* g, PlayState* play, Texture* texture, Vector2D pos, string tag, ExplosiveBulletPool* pool) : Enemy(g, player, pos, texture)
{
	_myBulletPool = pool;
